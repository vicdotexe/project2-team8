...
// title names adding to the keywords
    ...
    await artPieces[3].addKeywordsAsync(["women", "portrait", "earring", "Girl","pearl","earring"])
    await artPieces[4].addKeywordsAsync(["women", "sleep", "warm", "Tibet","girl" ])
    await artPieces[5].addKeywordsAsync(["women", "seashell", "hair", "trees", "birth", "venus"])
    await artPieces[6].addKeywordsAsync(["landscape", "trees", "trail", "rain" ,"park"])
    await artPieces[7].addKeywordsAsync(["abstract", "red", "faces", "L'amitie"])
    await artPieces[8].addKeywordsAsync(["landscape", "women", "flower", "trees", "poppies", "field"])
    ...
    await artPieces[12].addKeywordsAsync(["abstract", "colorful", "bridge", "bridge","eternity"])
    await artPieces[13].addKeywordsAsync(["landscape", "trees", "nature", "nature","walk","Ridgefield","Washington"])
    await artPieces[14].addKeywordsAsync(["landscape", "birds", "lake", "evening", "alone","now"])
    await artPieces[15].addKeywordsAsync(["time", "clock", "brown", "persistence","memory"])
    await artPieces[16].addKeywordsAsync(["abstract", "lines", "yellow", "5", "1948"])
    await artPieces[17].addKeywordsAsync(["waterfront", "park", "women", "grass", "sunday", "afternoon", "island", "Grande", "Jatte"])
    await artPieces[18].addKeywordsAsync(["angels", "bow","arrow", "triumph","Galatea"])
    await artPieces[19].addKeywordsAsync(["dogs", "gamble", "poker", "cards", "playing"])
